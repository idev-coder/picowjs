...
function generateMagicStrings(modules) {
  ...
  const template_h = fs.readFileSync(__dirname + '/picowjs_magic_strings.h.mustache', 'utf8')
  var rendered_h = mustache.render(template_h, { magicStrings: magicStringItems })
  const template_c = fs.readFileSync(__dirname + '/picowjs_magic_strings.c.mustache', 'utf8')
